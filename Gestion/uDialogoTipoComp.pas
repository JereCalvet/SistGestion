...
type
  TfrmDialogoTipoComp = class(TfrmDialogoGenerico)
    lbl1: TLabel;
    cxdbspndtID_TIPO_COMP: TcxDBSpinEdit;
    lbl2: TLabel;
    cxdbtxtdtNOMBRE: TcxDBTextEdit;
    lbl3: TLabel;
    cxdbtxtdtLETRA: TcxDBTextEdit;
  private
...
var
  frmDialogoTipoComp: TfrmDialogoTipoComp;
